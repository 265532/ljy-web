...
const PressureMap: React.FC<Props> = ({ isStress }) => {
  return (
    <div className="bg-[#0B121E]/60 border border-slate-900 rounded-[32px] p-8 h-[400px] flex flex-col relative overflow-hidden group">
      <div className="mb-6 relative z-10">
        <h3 className="text-sm font-black text-white uppercase tracking-widest">全球港口拥堵热力 (实时模拟)</h3>
      </div>

      <div className="flex-1 bg-slate-950/40 rounded-2xl border border-slate-900/50 flex items-center justify-center relative overflow-hidden">
        {/* 地图底图模拟 */}
      ...
      <div className="absolute bottom-6 left-10 text-[10px] font-black text-slate-600 uppercase tracking-widest flex items-center gap-2">
