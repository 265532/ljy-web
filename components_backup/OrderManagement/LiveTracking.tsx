...
const LiveTracking: React.FC = () => {
  return (
    <div className="bg-[#0B121E] border border-slate-800 rounded-3xl p-6 shadow-xl relative overflow-hidden">
      ...
      <div className="flex items-center gap-3 mb-8">
        ...
        <h3 className="text-sm font-black text-white uppercase tracking-widest">热点线路实时追踪</h3>
      </div>
...
const TrackingStep = ({ from, to, progress, vessel }: any) => (
  <div className="space-y-2">
    ...
    <div className="text-[9px] text-slate-600 font-bold italic tracking-tighter uppercase">Carrier: {vessel}</div>
  </div>
);
