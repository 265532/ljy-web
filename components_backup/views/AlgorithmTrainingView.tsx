...
import { Terminal, Cpu, Zap, Activity, Brain } from 'lucide-react';
      ...
      <div className="grid grid-cols-3 gap-8">
        <div className="col-span-2 space-y-8">
          <div className="bg-[#0B121E] rounded-3xl p-8 border border-slate-900">
             <div className="flex items-center gap-4 mb-8">
               <div className="w-12 h-12 bg-cyan-500/10 border border-cyan-500/30 rounded-2xl flex items-center justify-center text-cyan-400 shadow-[0_0_15px_rgba(6,182,212,0.1)]">
                 <Brain size={24} />
               </div>
               <div>
             ...
             <div className="space-y-6">
                ...
                <div className="grid grid-cols-3 gap-6 pt-4">
                  <div className="bg-slate-950/50 p-5 rounded-2xl border border-slate-900">
                  ...
                  <div className="bg-slate-950/50 p-5 rounded-2xl border border-slate-900">
                    <div className="text-[10px] text-slate-500 font-bold uppercase mb-1">探索率 (Epsilon)</div>
        ...
        <div className="space-y-8">
           <div className="bg-[#0B121E] rounded-3xl p-6 border border-slate-900">
              ...
              <div className="space-y-6">
                {[
                  { name: 'Cluster Node A', val: 92, status: 'Active' },
                  { name: 'Cluster Node B', val: 88, status: 'Active' },
                  { name: 'Storage Buffer', val: 42, status: 'Idle' },
                ].map(item => (
