    ...
    <div className="bg-[#0B121E] border border-slate-800 rounded-3xl p-8 shadow-2xl h-full flex flex-col">
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-3">
          ...
          <h3 className="text-sm font-black text-white uppercase tracking-widest">待办服务工单</h3>
        </div>
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-slate-800/50">
              <th className="pb-4 text-left text-[10px] font-black text-slate-500 uppercase tracking-widest">工单 ID</th>
              <th className="pb-4 text-left text-[10px] font-black text-slate-500 uppercase tracking-widest">用户</th>
              <th className="pb-4 text-left text-[10px] font-black text-slate-500 uppercase tracking-widest">问题描述</th>
              <th className="pb-4 text-left text-[10px] font-black text-slate-500 uppercase tracking-widest">提交时间</th>
              <th className="pb-4 text-left text-[10px] font-black text-slate-500 uppercase tracking-widest">优先级</th>
          ...
          <tbody className="divide-y divide-slate-800/20">
            {tickets.map((tkt, idx) => (
              <tr key={idx} className="group hover:bg-slate-800/10 cursor-pointer transition-colors">
                ...
                <td className="py-6 text-sm font-bold text-slate-200">{tkt.user}</td>
                <td className="py-6 text-xs text-slate-400 font-medium max-w-xs truncate">{tkt.issue}</td>
                <td className="py-6 text-xs text-slate-500 font-medium">{tkt.time}</td>
                <td className="py-6">
